            ...
            <div class="wrapper">
                <div class="about">
                    ...
                    <c:forEach var="post" items="${userPosts}">
                        <p class="field">
                            <c:out value="TITLE - ${post.postName}| " />
                            <c:out value="TEXT - (${post.postText})" />
                        <div class="changeData_link">
                            <a href="/web/changePost?savePostId=${post.postId}">|Change post|</a>
                            <a href="/web/deletePost?savePostId=${post.postId}">|Delete post|</a>
                        </div>
                        </p>
                    </c:forEach>
